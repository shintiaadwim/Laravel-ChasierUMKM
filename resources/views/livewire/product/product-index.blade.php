    ...
    <div class="flex items-start justify-between pb-4">
        <div class="flex w-full justify-between">
            <button type="button" data-modal-target="tambah-produk-modal" data-modal-toggle="tambah-produk-modal"
                ...
                focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-2 dark:bg-gray-800 dark:text-white dark:border-gray-600
                dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Add
                Product
            </button>
            <div id="InputSearch">
                ...
                <div class="relative">
                    ...
                    <input wire:model="search" type="search" id="search"
                        class="block p-2 pl-10 text-sm w-36 text-gray-900 border border-gray-300 rounded-lg  bg-gray-50
                        focus:ring-blue-500 focus:border-blue-500 sm:max-w-md sm:w-full dark:bg-gray-700 dark:border-gray-600
