                ...
                <form wire:submit.prevent="submit" class="space-y-4 md:space-y-6" action="" method="post">
                    ...
                    <div>
                        ...
                        <input wire:model="nama_product" required type="text" name="nama_product" id="nama_product"
                            class="rounded-lg block w-full p-2.5 sm:text-sm  @error('nama_product') {{ implode(' ', [
                                'bg-red-50',
                                'border-red-500',
                                'text-red-900',
                                'placeholder-red-700',
                    ...
                    <div class="space-y-4 sm:space-y-0 sm:grid grid-cols-2 gap-2 ">
                        <div>
                            ...
                            <input wire:model="kode_product" required type="text" name="kode_product"
                                ...
                                class=" rounded-lg block w-full p-2.5 sm:text-sm  @error('kode_product') {{ implode(' ', [
                                    'bg-red-50',
                                    'border-red-500',
                                    'text-red-900',
                                    'placeholder-red-700',
                        ...
                        <div>
                            ...
                            <input wire:model="harga_product" required type="text" name="harga_product"
                                ...
                                class="rounded-lg block w-full p-2.5 sm:text-sm  @error('harga_product') {{ implode(' ', [
                                    'bg-red-50',
                                    'border-red-500',
                                    'text-red-900',
                                    'placeholder-red-700',
                    ...
                    <button required type="submit"
                        class="w-full text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700
                        dark:focus:ring-indigo-800">Tambahkan
                        Produk</button>
                </form>
            </div>
        </div>
