<div>
    ...
    <div
        ...
        {{-- ============= Select Product to Table Cashier ============= --}}
        <form wire:submit.prevent="submit" class="mb-10" action="">
            <div class="grid grid-cols-12 gap-1">
                ...
                <div class="| col-span-9 md:col-span-8">
                    ...
                    @error('product_id')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>Produk
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 columns-2 md:columns-1">Product</th>
