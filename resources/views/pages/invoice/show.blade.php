            ...
            <div class="flex w-full">
                <div class="grid grid-cols-2 gap-12">
                    <div class="text-sm font-light text-slate-500 dark:text-slate-400">
                        ...
                        <p>{{ $order->no_order }}</p>
                        <p class="mt-2 text-sm font-normal text-slate-700 dark:text-slate-300 ">Date</p>
        ...
        <div class="py-6 md:px-9">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 columns-3 md:columns-1">Product</th>
                    ...
                    <tbody>
                        @foreach ($order->orderProduct as $item)
                            <tr class="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 truncate">Rp.
                                    {{ number_format($item->listProduct->harga_product) }}</td>
                                <td class="px-6 py-4 truncate">Rp. {{ number_format($item->total) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="mt-8 md:flex md:justify-end">
                <div class="md:w-64 grid grid-cols-2 gap-1">
                    <div>
                        <p class="mb-3 font-semibold md:text-left text-gray-500 dark:text-gray-200">Total Pembelian</p>
                        <p class="mb-3 font-semibold md:text-left text-gray-500 dark:text-gray-200">Pembayaran</p>
                        <p class="mb-3 font-semibold md:text-left text-gray-500 dark:text-gray-200">Kembalian</p>
                    </div>
                    <div>
                        <p class="mb-3 font-semibold text-end text-gray-600 dark:text-gray-50">Rp.
                            {{ number_format($order->grand_total) }}</p>
                        <p class="mb-3 font-semibold text-end text-gray-600 dark:text-gray-50">Rp.
                            {{ number_format($order->pembayaran) }}</p>
                        <p class="mb-3 font-semibold text-end text-gray-600 dark:text-gray-50">Rp.
                            {{ number_format($order->kembalian) }}</p>
                    </div>
                </div>
            </div>
        </div>
